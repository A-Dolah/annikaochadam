  ...
  <div className="bg-white w-full sm:w-10/12 xl:w-1/2 pb-4 flex flex-col items-center">
    ...
    <BorderFrame>
      ...
      <ScheduleItem
        ...
        description="Det bjuds in till grillfest i Adams föräldrars trädgård. Här bjuds det på mat och dryck. Vi anordnar också lite olika aktiviteter. Kom när det passar!"
      ...
      <ScheduleItem
        ...
        description="Vigsel är planerad till Dalby kyrka, ett stenkast från festlokalen Dalby Gästis Tingshus. Dalby kyrka kan dock komma att genomgå renovering, och då sker vigsel istället i grannbyn Torna Hällestads kyrka."
        icon={<ChurchIcon width={42} height={42} />}
      />
      <ScheduleItem
        time="16.00 – 17.00"
        happening="Fördrink, Dalby Gästis trädgård"
        description="Efter vigsel och innan bröllopsmiddagen samlas vi i Dalby Gästis härliga trädgård för bubbel, snittar, mingel och bilder."
        icon={<MingleIcon width={42} height={42} />}
      />
      <ScheduleItem
        time="17.00 – 21.00"
        happening="Middag, Dalby Gästis Tingshus"
        description="I Dalby Gästis nyrenoverade Tingshus har vi bröllopsmiddag som anordas av krögarna som driver Dalby Gästis. Här finns möjlighet att hålla tal och/eller uppträda. Det är Annikas bror Per och Adams syster Sarah håller i middagen, så stäm gärna av tal- och uppträdanden med dem!"
      ...
      <ScheduleItem
        time="10.00 – 13.00"
        happening="Brunch, Dalby Gästis Hotell"
